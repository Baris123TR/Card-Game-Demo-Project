...
public class LevelDesignerScript : MonoBehaviour
{
    ...
    public IEnumerator WheelLoader()
    {
        ...
        yield return _publicValues.ObjectAppearAndDissappearTween(_publicValues._spinScript._wheelParent,
            _publicValues._spinScript._wheelScaleAtStart)/*.WaitForCompletion()*/;
        yield return _publicValues._spinScript._spinButton.interactable = true;
    }
}